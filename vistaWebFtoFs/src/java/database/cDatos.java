...
public class cDatos {
    ...
    public cDatos(String usuarioBD, String passwordBD, String url, String driverClassName, boolean SQLite) {
    ...
    public cDatos() {
        ...
        this.usrBD = "root";
        this.passBD = "n0m3l0";
        this.urlBD = "jdbc:mysql://127.0.0.1:3306/COYDm";
    ...
    public void conectar() throws SQLException {
        try {
            ...
            if(this.SQLite) {
                this.conn = DriverManager.getConnection(this.SQLiteDbPath);
            } else {
